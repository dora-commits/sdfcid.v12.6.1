class ResNetClassifier(nn.Module):
    ...
    def train_model(self, trainloader, testloader, num_epochs, learning_rate, data_name, fold_id):
        ...
        path = '/content/drive/MyDrive/Colab/' + data_name + '/model/' + str(fold_id + 10)
        if not os.path.exists(path):
          os.makedirs(path)
        path_model = path + '/model_SMOTEWAEGAN_CIFAR10.pth'
